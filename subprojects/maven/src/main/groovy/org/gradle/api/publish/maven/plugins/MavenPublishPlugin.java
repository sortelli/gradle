...
public class MavenPublishPlugin implements Plugin<Project> {
    ...
    private MavenPublication createPublication(final String name, final Project project, Component component) {
        ComponentInternal componentInternal = (ComponentInternal) component;
        ...
        DefaultMavenPublication publication = instantiator.newInstance(
                ...
                name, instantiator, projectIdentity, componentInternal, null, fileResolver, project.getTasks()
        );
